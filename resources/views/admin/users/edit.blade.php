    ...
    <div class="user-header">
        <div class="user-header-content">
            ...
            <div class="user-header-info">
                <h1 class="heading-serif text-2xl font-semibold" id="headerName">{{ $user->full_name }}</h1>
                <p class="user-header-meta">Editing user profile and permissions</p>
            </div>
        </div>
    </div>

    <div class="form-card with-header">
        <form method="POST" action="{{ route('admin.users.update', $user) }}" id="editUserForm">
                            ...
                            <div class="role-card-content">
                                <div class="role-icon">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="{{ $role->code === 'admin' ? 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' : 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' }}"></path>
                                    </svg>
                                </div>
                                <div>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        <label for="password" class="form-label">New Password <span class="optional">(Optional)</span></label>
...
<script>
    ...
    function updatePreviews() {
        ...
        headerName.textContent = (first + ' ' + last).trim() || 'User';
    }

    firstnameInput.addEventListener('input', updatePreviews);
    lastnameInput.addEventListener('input', updatePreviews);
