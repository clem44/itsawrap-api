        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}" id="editUserForm">
            ...
            <div class="form-section">
                ...
                <div class="role-cards">
                    <label class="role-card user {{ old('role_id', $user->role_id) == 2 ? 'selected' : '' }}" data-role="user">
                        <input type="radio" name="role_id" value="2" {{ old('role_id', $user->role_id) == 2 ? 'checked' : '' }}>
                    ...
                    <label class="role-card admin {{ old('role_id', $user->role_id) == 1 ? 'selected' : '' }}" data-role="admin">
                        <input type="radio" name="role_id" value="1" {{ old('role_id', $user->role_id) == 1 ? 'checked' : '' }}>
                        <div class="role-card-content">
                            <div class="role-icon">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
